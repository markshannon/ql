...
string best_description_builtin_object(Object o) {
    ...
    (
        result = o.toString()
        or
        not exists(o.toString()) and py_cobjectnames(o.asBuiltin(), result)
        or
...
predicate builtin_object_sanity(string clsname, string problem, string what) {
    exists(Object o |
        ...
        not exists(o.getAnInferredType()) and not py_cobjectnames(o.asBuiltin(), _) and problem = "neither name nor type"
        or
        uniqueness_error(count(string name | py_cobjectnames(o.asBuiltin(), name)), "name", problem)
        or
